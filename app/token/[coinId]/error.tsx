          ...
          <div className="max-w-2xl space-y-5">
            <div className="space-y-3">
              ...
              <h1 className="text-3xl font-bold tracking-tight text-[color:var(--foreground)] sm:text-4xl">
                This token view couldn&apos;t load cleanly.
              </h1>
              <p className="text-sm text-[color:var(--muted)] sm:text-base">
                The provider or cache request failed before enough token data was available.
                Retry the request, or search for the token again.
              </p>
              {error.digest ? (
